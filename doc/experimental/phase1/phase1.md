...
Follow these [instructions](../phase1/disable-verrazzano.md) to disable the Verrazzano controllers on the cluster.
...
[Generated Kubernetes Manifests from OAM](../phase1/oam-to-kubernetes.md)
