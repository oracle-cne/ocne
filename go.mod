...
require (
	...
	github.com/dypflying/go-qcow2lib v1.0.1-0.20240602125421-ea63654c61a5
...
require sigs.k8s.io/cluster-api/api v1.14.0
...
replace github.com/cyphar/filepath-securejoin v0.7.0 => github.com/cyphar/filepath-securejoin v0.4.1
